...
namespace PlayModeTest
{
    ...
    public class MainMenuButtonsTests
    {
        ...
        [Test]
        public async void UIMainMenu_OnContinueClicked_GameSceneLoaded_True()
        {
            //Arrange
            Directory.Delete(MainSaveDirectory.Instance.MainSaveDirInfo.FullName, true);
            string sub1 = "sub1";
        ...
        [Test]
        public async void UIMainMenu_OnNewGameClicked_GameSceneLoaded_True()
        {
            //Arrange
            //Act
            mainMenuComponent.OnClickNewGame();
            Scene gameScene = SceneManager.GetSceneByName("Game");
            //Assert
            Assert.IsTrue(gameScene.isLoaded);
        }
